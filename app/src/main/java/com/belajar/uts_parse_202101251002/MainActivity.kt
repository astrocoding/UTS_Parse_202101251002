...
import com.belajar.uts_parse_202101251002.databinding.ActivityMainBinding
import com.belajar.uts_parse_202101251002.ui.home.HomeFragment
        ...
        return when (item.itemId) {
            R.id.about -> {
                ...
                supportFragmentManager.beginTransaction()
                    .replace(R.id.app_bar_main, AboutFragment())
                    .addToBackStack(null)
                    .commit()
